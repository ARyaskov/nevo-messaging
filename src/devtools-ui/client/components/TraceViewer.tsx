      ...
      {!uuid ? (
        ...
        <section className="nv-card">
          <div className="nv-row" style={{ marginBottom: 12, gap: 24 }}>
            <span>
              <strong>Spans:</strong> {trace.matches.length}
            </span>
            <span>
              <strong>Total duration:</strong> {formatDuration(trace.totalMs)}
            </span>
            <span className="nv-muted" suppressHydrationWarning>
              Started {formatRelative(trace.firstTs)}
            </span>
          </div>
